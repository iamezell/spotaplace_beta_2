...
exports.index = function(req, res){
	var auctionId = req.query.auction;
	var POR = req.query.POR;
	var match = false;
...
exports.enterAuction = function(req, res){
	var auctionID = req.body['auction-id'];

	// var sessionID

	console.log("in enter auction");
	auction.findOne({_id:auctionID}, function(err, auction){
		// console.log(auction);
		res.render('auctions', { title: 'Welcome to your Spotaplace Beta Auction', 'auction': auction});
	})
